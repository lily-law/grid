...
Grid.prototype.nths = function(n, from = this.rows(), starting = 0,) {
    return this.flattenArray(from).slice(starting).filter((v, i) => i%n === 0);
}
Grid.prototype.merge = function(withArr, options = {replaceIfBigger: false, replaceIfSmaller: false, insertWhereEmpty: true, replaceAll: false}) {
